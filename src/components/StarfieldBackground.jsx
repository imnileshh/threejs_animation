...
export default function StarfieldBackground({ spiralTrigger }) {
    ...
    useEffect(() => {
        ...
        const material = new THREE.ShaderMaterial({
            uniforms: {
                ...
                uTime: { value: 0 }, // <--- NEW
                uSpiralProgress: { value: 0 }, // <--- NEW
                uMergeProgress: { value: 0 }, // <--- NEW
            },
            vertexShader: `
  ...
  gl_PointSize = size;
      ...
      `,
        ...
        window.addEventListener('scroll', () => {
            ...
            // stars.position.y = -(scrollY % 2000); // recycle every 200 unit
        ...
        // 🔄 Spiral and merge animation control
